# -*- coding: utf-8 -*-
"""
Created on Tue Mar 16 15:51:37 2021
...
categorias = ["Detención Equipo Programada", "Detención Proceso Programada"]
...
MolinoSAGFallaEquipo = MolinoSAG[MolinoSAG["TUM"]=="Detención Equipo Programada"].reset_index(drop = True)
MB5FallaProces = MB5[MB5["TUM"]=="Detención Proceso Programada"].reset_index(drop = True)
MB6FallaProces = MB6[MB6["TUM"]=="Detención Proceso Programada"].reset_index(drop = True)
MB7FallaProces = MB7[MB7["TUM"]=="Detención Proceso Programada"].reset_index(drop = True)
MB8FallaProces = MB8[MB8["TUM"]=="Detención Proceso Programada"].reset_index(drop = True)
MB5FallaProcesSAG = MB5FallaProces[MB5FallaProces["MDD"]=="Indisponibilidad de Molino SAG Programado"].reset_index(drop = True)
MB6FallaProcesSAG = MB6FallaProces[MB6FallaProces["MDD"]=="Indisponibilidad de Molino SAG Programado"].reset_index(drop = True)
MB7FallaProcesSAG = MB7FallaProces[MB7FallaProces["MDD"]=="Indisponibilidad de Molino SAG Programado"].reset_index(drop = True)
MB8FallaProcesSAG = MB8FallaProces[MB8FallaProces["MDD"]=="Indisponibilidad de Molino SAG Programado"].reset_index(drop = True)
...
cruceMB5, indMB5 = cruceData(MolinoSAG, MB8FallaProcesSAG)
...
ComparativeIni["MB5"]=cruceMB5.describe()["diff_ini"]
...
plt.title("Distribucion Desfase SAG a MB, Programado")
...
plt.title("Distribución Detención SAG y MB Trabajo en Vacio Program.")
plt.ylabel("N° de Detenciones")
plt.xlabel("Horas")
...
plt.title("Distribución Detención SAG y MB Trabajo en Vacio Program. Mean")
plt.grid()
...
DetenSAGSinMB["MDD"].hist()
plt.title("Distribución Detención SAG y MB Trabajo en Vacio Program. Count")
plt.ylabel("N° de Detenciones")
plt.xticks(rotation= "vertical")
plt.show()
...
plt.title("Cantidad de Trabajos en Vacio Por Equipo, program.")
plt.xlabel("equipo")
plt.ylabel("N° de Trabajos en Vacio")
plt.grid()
plt.show()

potenciaEnVacio = np.array([15167,15298, 14961, 15098, 14876, 15021,15167,15298, 14961, 15098, 13461, 12378, 11298, 11341, 11194, 11498, 12052,12989, 13797, 14345, 14876, 15098,15167,15298, 14961, 15098, 14876, 15021])

potenciaEnApa =np.array([15167,15298, 14961, 15098, 14876, 15021,15167,15298, 14961, 15098, 6192, 2245, 0, 0, 0, 0,1178, 2134,4521,6198, 9468, 15098,15167,15298, 14961, 15098, 14876, 15021])

time = np.arange(0,280,step =10)
plt.plot(time,potenciaEnVacio, color ="blue", label= "Potencia en Vacío",linewidth=1 )
plt.plot(time,potenciaEnApa, color= "red", label = "Potencia Apagado",linewidth=1)
plt.fill_between(time, potenciaEnVacio,potenciaEnApa,color='green',hatch = "X",edgecolor = "g",alpha=0.2, label = "Potencial Ahorro")
plt.title("Evolucion temporal de la potencia en Vacio y en Apagado ")
plt.xlabel("Minutos")
plt.ylabel("Potencia")
plt.legend()
plt.grid()
